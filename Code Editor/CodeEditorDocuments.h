...
//	virtual void				SetValid( bool inValid ) = 0;
	...
	virtual void Select( sLONG inStartSelection, sLONG inEndSelection, sLONG inFirstVisibleLine, sLONG inLastVisibleLine, bool inRectangularSelection = false ) = 0;
	virtual void SafeSelect( sLONG inStartPosition, sLONG inEndPosition, sLONG inFirstVisibleLine, sLONG inLastVisibleLine ) = 0;
	virtual void DoEnd( Boolean inShift, Boolean inControl ) = 0;
...
public: 
	...
	virtual bool CanHiliteSameWord( sBYTE inStyle ) { return false; }
	...
	virtual bool CanGotoDefinition( ICodeEditorDocument* inInterface, sLONG inLineIndex, sLONG inOffset, sLONG& outStartOffset, sLONG& outEndOffset ) { return false; }
