...
DataStoreCatalog.prototype.addOutsideCatalog = function(catalogName, catalogPath, username, password) {
...
DataStoreCatalog.prototype.addSQLCatalog = function(catalogName, outcat) {
...
DataStoreCatalog.prototype.addClass = function(className, collectionName, scope, extendClass, otherProperties) {
    ...
    */
    ...
    var dataClass = new this.DataClass(collectionName || null, scope || null, extendClass || null, otherProperties || null);
...
*/
    ...
    var attribute = new this.Attribute(kind || null, type || null, param4 || null, otherProperties || null);
