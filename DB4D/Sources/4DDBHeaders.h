...
#define FreeMemWaitOnLockWrite 0  // les big objets qui sont locke en Write ne peuvent pas etre libere par un autre process quand ce flag est a 1
	...
	#define debug_entityRecord 0

	#define debug_blobOrphans 0

	#define debug_bittab_threadsafe 0
...
#include "CodeReg.h"
#include "Enterprise/Metrology.h"
//#include "BufDisk.h"
#include "DB4DMgr.h"
#include "Cache.h"
#include "BitTable.h"
