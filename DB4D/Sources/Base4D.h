...
//	inline CClass* GetBaseRef(void) { return BaseRef; };
	...
	VError IntegrateJournal(DB4DJournalParser* jparser, uLONG8 from, uLONG8 upto, uLONG8 *outCountIntegratedOperations, VDB4DProgressIndicator* InProgress, bool isMirror = false, sLONG8 lastMirrorAction = -1);
