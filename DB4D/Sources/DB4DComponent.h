...
/*
	...
	*/
	...
	virtual	void				SetAllDB4DGlobalProperties(VJSObject& globalObject, CDB4DBaseContext *inBaseContext, void* ProjectRef);
...
{
public:
	VDB4DQueryInfoCollector(CDB4DBaseContext* inContext);
	 ...
	 */
	virtual	VJSONObject*	CollectInfo(VProgressIndicator *inIndicator);
