...
class AttributeType : public IDebugRefCountable
{
	public:
...
class EntityRelation : public IDebugRefCountable
{
	public:
...
class EntityCollection  : public VComponentImp<CDB4DEntityCollection>
{
	public:
...
class EntityCollectionIterator : public IDebugRefCountable
{
	public:
...
class EntityRecord : public VComponentImp<CDB4DEntityRecord>
{
	public:
		...
		{
			return getAttributeValue(VImpCreator<EntityAttribute>::GetImpObject(inAttribute), err, fContext);
		}
		...
		{
			return setAttributeValue(VImpCreator<EntityAttribute>::GetImpObject(inAttribute), inRelatedEntity == nil ? nil : VImpCreator<EntityRecord>::GetImpObject(inRelatedEntity));
		}

		virtual VErrorDB4D SetAttributeValue(const XBOX::VString& inAttributeName, CDB4DEntityRecord* inRelatedEntity)
		{
			return setAttributeValue(inAttributeName, inRelatedEntity == nil ? nil : VImpCreator<EntityRecord>::GetImpObject(inRelatedEntity));
		}
		...
		{
			return resetAttributeValue(VImpCreator<EntityAttribute>::GetImpObject(inAttribute));
		}
...
#if debuglr
		virtual CComponent* Retain(const char* DebugInfo = nil);
		virtual void Release(const char* DebugInfo = nil);
#endif
...
class EntityModelCatalog : public IDebugRefCountable
{
...
class DataSet : public IDebugRefCountable
{
public:
