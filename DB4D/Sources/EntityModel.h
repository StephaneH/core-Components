...
class ENTITY_API EntityModelCatalog : public IDebugRefCountable
{
	...
	public:
		...
		*/
		...
		VError LoadEntityModels(const VValueBag& bagEntities, ModelErrorReporter* errorReporter, unordered_map_VString<VRefPtr<VFile> >* outIncludedFiles = nil);
		VError LoadEntityModels(const VFile& inFile, bool inXML = true, ModelErrorReporter* errorReporter = false, const VString* inXmlContent = nil, unordered_map_VString<VRefPtr<VFile> >* outIncludedFiles = nil);
...
class ModelJSTransformer
{
	public:
		...
		VError TransformJSIntoBag(VFile& inJSFile, const VString& modelRoot, VValueBag& bagEntities, unordered_map_VString<VRefPtr<VFile> >* outIncludedFiles, ModelErrorReporter* errorReporter);
