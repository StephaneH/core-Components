...
class ENTITY_API EntityAttribute : public CDB4DEntityAttribute
{
	public:
		...
		*/
		...
		VError FromBag(const VValueBag* bag, EntityModelCatalog* catalog, bool fieldmustexits, bool devMode, bool limitedChange);
...
class ENTITY_API EntityModel : public CDB4DEntityModel
{
	public:
		...
		VError FromBag(const VValueBag* inBag, EntityModelCatalog* catalog, bool devMode, bool addToClassOnly, bool allowAttributeChange);
...
class ENTITY_API EntityModelCatalog : public IDebugRefCountable
{
	...
	public:
		...
		*/
		...
		VError addJSExtensions(Base4D* associate, VFile* jsFile, bool devMode);
...
class ModelJSTransformer
{
	public:
		...
		VError TransformJSIntoBag(VFile& inJSFile, const VString& modelRoot, VValueBag& bagEntities, unordered_map_VString<VRefPtr<VFile> >* outIncludedFiles, bool devMode);
