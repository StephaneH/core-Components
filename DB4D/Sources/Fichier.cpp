...
{
	assert(fFieldsByID.find(smallID) == fFieldsByID.end());
...
{
	//WAK0084654: O.R., Oct 28th 2013: tables must be logged otherwise automatic integration will not work
...
VError DataTableRegular::DelRecordForTrans(sLONG n, BaseTaskInfo* context, PrimKey* primkey)
{
	//CheckUseCount();
	VError err = VE_OK;
