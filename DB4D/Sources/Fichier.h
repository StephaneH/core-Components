...
{
	public:
		virtual ~IReplicationOutputFormatter() {}
...
class ReplicationOutputBinaryFormatter : public VObject, public IReplicationOutputFormatter
{
	public:
...
class ReplicationOutputJSONFormatter : public VObject, public IReplicationOutputFormatter
{
	public:
