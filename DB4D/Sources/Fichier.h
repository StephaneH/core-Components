...
//		CClass* GetSelectionRef(void) { return SelectionRef; };
		...
		*/
		...
		Boolean CheckUniqueness(FicheInMem* fic, const NumFieldArray& deps, BaseTaskInfo* context, sLONG beginprimkey,	XBOX::VProgressIndicator* inProgress);
...
{ 
	...
	public:
		...
		*/
		...
		virtual VError DelBlobForTrans(sLONG n, BaseTaskInfo* context, bool alterModifState, PrimKey* primkey, sLONG fieldnum) = 0;
...
{ 
	...
	public:
		...
		virtual VError DelBlobForTrans(sLONG n, BaseTaskInfo* context, bool alterModifState, PrimKey* primkey, sLONG fieldnum);
...
{ 
	public:
		...
		virtual VError DelBlobForTrans(sLONG n, BaseTaskInfo* context, bool alterModifState, PrimKey* primkey, sLONG fieldnum) { return ThrowError(VE_DB4D_TABLEISLOCKED, noaction); };
