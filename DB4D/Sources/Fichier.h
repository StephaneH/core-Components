...
{ 
	...
	public:
		...
		*/
		...
		virtual VError DelRecordForTrans(sLONG n, BaseTaskInfo* context, PrimKey* primkey) = 0;
...
{ 
	...
	public:
		...
		virtual VError DelRecordForTrans(sLONG n, BaseTaskInfo* context, PrimKey* primkey);
...
{ 
	public:
		...
		virtual VError DelRecordForTrans(sLONG n, BaseTaskInfo* context, PrimKey* primkey) { return ThrowError(VE_DB4D_TABLEISLOCKED, noaction); };
