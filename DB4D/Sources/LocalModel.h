...
class LocalEntityModel : public EntityModel
{
	public:
		...
		VError BuildIndexes(bool dataWasAlreadyThere);
...
public:
	...
	VError BuildIndexes(Table* tt, bool dataWasAlreadyThere);
...
class LocalEntityModelCatalog : public EntityModelCatalog
{
	public:
		...
		EntityModel* RetainEntityModelByTableNum(sLONG tablenum);
...
class LocalEntityRecord : public EntityRecord
{
	public:
		...
		virtual VError Save(Transaction* *trans, BaseTaskInfo* context, uLONG stamp, bool allowOverrideStamp = false, bool refreshOnly = false);
		virtual VErrorDB4D Save(uLONG stamp, bool allowOverrideStamp = false, bool refreshOnly = false);
...
//		virtual VErrorDB4D Validate();
		...
		virtual PrimKey* RetainRelatedAttributeKey(const EntityAttribute* inAttribute, VError& err);
