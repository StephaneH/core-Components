			...
			else
			{
				...
				else
				{
					if (waitforvalue)
					{
						...
						if (keepmodel)
						{
							AddSearchLineEm(attpath, objpath, oper, &s, false, checkfornull);
						}
						else
						{
									...
									if (att->GetScriptKind() == script_javascript && context != nil)
									{
										...
										else
										{
											...
											if (!s.IsEmpty() && s[0] == ':')
											{
												...
												AddSearchLineEm(finalpath, objpath, oper, &s, false, checkfornull, lastdestinstance);
									...
									else
									{
										...
										else
										{
											...
											else
											{
												VCompareOptions options;
												options.SetDiacritical(false);
												AddSearchLineEmSimple(att, objpath, oper, &s, options, lastdestinstance, checkfornull);
											}
										}
									}
								}
