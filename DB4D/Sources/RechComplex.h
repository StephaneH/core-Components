...
class ComplexSelection : public ObjInCacheMemory, public IRefCountable, public IObjToFree
{
	public:
		...
		{
			assert((((*p)[kNbElemInComplexSel]) & 0xFFFF) > 0);
			(*p)[kNbElemInComplexSel]--;
		}
...
enum { aucuncomplextokenrech=0L, rc_ParentG, rc_ParentD, rc_ComplexSQLScript, rc_Line, rc_Operator, rc_Script, rc_Not, rc_LineArray, rc_LineJoin, rc_Sel, rc_SQLScript };
