...
class TreeMem : public ObjInCacheMem, public IOccupable
{
	public:
		...
		VError GetLockerInfo(RecIDType curpos, sLONG nbelem, VJSONArray* ioArr, OccupableStack* curstack);
...
class TreeMemHeader : public ObjInCacheMem, public IOccupable
{
	public:
		...
		VError GetLockerInfo(VJSONArray* ioArr, OccupableStack* curstack);
...
class AddressTable : public ObjInCacheMem, public IObjToFlush
{
	public:
		...
		virtual VError SubLibereEspaceDisk(sLONG nbelem, VDB4DProgressIndicator* InProgress, OccupableStack* curstack);
...
class AddrTable : public ObjCacheInTree
{
	public:
		...
		VError SubLibereEspaceDisk(sLONG nbelem, VDB4DProgressIndicator* InProgress = nil);
