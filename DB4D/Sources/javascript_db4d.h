...
public:
	...
	static	void			GetDefinition( ClassDefinition& outDefinition);
	static	VJSObject		CreateInstance( JS4D::ContextRef inContext, EntityModelCatalog* inCatalog);
...
typedef map<VString, JS4D::ValueRef, CompareLessVStringStrict> MapOfJSValues;
