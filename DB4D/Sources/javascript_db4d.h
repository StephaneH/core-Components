...
public:
	...
	static	void			GetDefinition( ClassDefinition& outDefinition);
	static	VJSObject		CreateInstance( const VJSContext& inContext, Base4D *inDatabase);
	...
	static void _ExportAsJSON(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase);  // _ExportAsJSON(Folder | StringURL, number : nbBlobsPerLevel, number : maxExportFileSize, number : blobThreshold)
	static void _ImportFromJSON(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase);  // importFromJSON(Folder | StringURL)
	...
	static void _setLogFile(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  setLogFile(file, bool append, object options)
	static void _startLogging(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  startLogging()
	static void _stopLogging(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  stopLogging()
	static void _flushLog(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  flushLog()

	static void _getStats(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  getStats()
	static void _setStatsInterval(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); //  _setStatsInterval()

	static void _tempSetIndexNewFourche(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); 
	static void _resurectGhostTables(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase); 

	static void _requireModel(XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase);
	...
	*/
	...
	static void	_getJournalManager(XBOX::VJSParms_getProperty& ioParms, Base4D* inDatabase);
...
class VJSJournalPool : public XBOX::VJSClass<VJSJournalPool, JournalPool>
{
public:
	typedef VJSClass<VJSJournalPool, JournalPool>	inherited;

	static	void		Initialize(const XBOX::VJSParms_initialize& inParms, JournalPool* inJournalPool);
	static	void		Finalize(const XBOX::VJSParms_finalize& inParms, JournalPool* inJournalPool);
	static	void		GetDefinition(ClassDefinition& outDefinition);

	static void			_setFolder(XBOX::VJSParms_callStaticFunction& ioParms, JournalPool* inJournalPool); // setFolder(folder)
	static void			_activate(XBOX::VJSParms_callStaticFunction& ioParms, JournalPool* inJournalPool);
	static void			_nextJournalFile(XBOX::VJSParms_callStaticFunction& ioParms, JournalPool* inJournalPool);


	static void			_getActivated(XBOX::VJSParms_getProperty& ioParms, JournalPool* inJournalPool);
	static void			_getFolder(XBOX::VJSParms_getProperty& ioParms, JournalPool* inJournalPool);
...
class VJSDatabaseForMaintenance : public XBOX::VJSClass<VJSDatabaseForMaintenance, Base4D>
{
public:
	typedef VJSClass<VJSDatabaseForMaintenance, Base4D>	inherited;
	...
	static void			_backup( XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase);
	static void			_verify( XBOX::VJSParms_callStaticFunction& ioParms, Base4D* inDatabase);
};
...
class VJSEntityModelCatalog : public XBOX::VJSClass<VJSEntityModelCatalog, EntityModelCatalog>
{
public:
	typedef VJSClass<VJSEntityModelCatalog, EntityModelCatalog>	inherited;
	
	static	void			Initialize( const XBOX::VJSParms_initialize& inParms, EntityModelCatalog* inCatalog);
	static	void			Finalize( const XBOX::VJSParms_finalize& inParms, EntityModelCatalog* inCatalog);
	static	void			GetProperty( XBOX::VJSParms_getProperty& ioParms, EntityModelCatalog* inCatalog);
	static	void			GetPropertyNames( XBOX::VJSParms_getPropertyNames& ioParms, EntityModelCatalog* inCatalog);
	static	void			GetDefinition( ClassDefinition& outDefinition);
	static	VJSObject		CreateInstance( const VJSContext& inContext, EntityModelCatalog* inCatalog);

	static void _GetName(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // String : GetName()
	static void _StartTransaction(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // StartTransaction()
	static void _Commit(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // Commit()
	static void _RollBack(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // RollBack()
	//static void _TransactionLevel(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // Number : TransactionLevel()
	static void _getIndices(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); // Array : getIndices()
	static void _close(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); // close(SyncEventName) : returns null or a SyncEvent

	static void _setLogFile(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); //  setLogFile(file, bool append, object options)
	static void _startLogging(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); //  startLogging()
	static void _stopLogging(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); //  stopLogging()
	static void _flushLog(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); //  flushLog()

	static void _queryOptions(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog); // bool : queryOptions(object options ) options: { queryPlan: bool, queryPath: bool }

	static void _getModelDefinition(XBOX::VJSParms_callStaticFunction& ioParms, EntityModelCatalog* inCatalog);  // Object : getModelDefinition()

	static void _getEntityModels( XBOX::VJSParms_getProperty& ioParms, EntityModelCatalog* inCatalog);
};
...
class VJSCatalogEMEnumerator : public XBOX::VJSClass<VJSCatalogEMEnumerator, EntityModelCatalog >
{
public:
	typedef VJSClass<VJSCatalogEMEnumerator, EntityModelCatalog >	inherited;
...
public:
	...
	static void _exportAsSQL(XBOX::VJSParms_callStaticFunction& ioParms, EntityModel* inModel);
	static void _exportAsJSON(XBOX::VJSParms_callStaticFunction& ioParms, EntityModel* inModel);
	static void _ImportFromJSON(XBOX::VJSParms_callStaticFunction& ioParms, EntityModel* inModel);  // importFromJSON(Folder | StringURL)
	...
	static void _allowAttribute(XBOX::VJSParms_callStaticFunction& ioParms, EntityModel* inModel);  // bool : allowAttribute(string : attname, string: perm "read,update,create")
...
//	static void _getUnique( XBOX::VJSParms_getProperty& ioParms, EntityAttribute* inAttribute);
	...
	static void _getUUID( XBOX::VJSParms_getProperty& ioParms, EntityAttribute* inAttribute);
...
public:
	...
	static void _getAttributeProperty(XBOX::VJSParms_callStaticFunction& ioParms, EntitySelectionIterator* inSelIter);  // value : getAttributeProperty(attribute | attributeName, propertyName)
	static void _setAttributeProperty(XBOX::VJSParms_callStaticFunction& ioParms, EntitySelectionIterator* inSelIter);  // setAttributeProperty(attribute | attributeName, propertyName, value)
...
public:
	...
	static void _exportAsSQL(XBOX::VJSParms_callStaticFunction& ioParms, EntityCollection* inSelection);  
	static void _exportAsJSON(XBOX::VJSParms_callStaticFunction& ioParms, EntityCollection* inSelection); 
...
typedef map<VString, XBOX::VJSValue, CompareLessVStringStrict> MapOfJSValues;
...
class DynamicObj
{
	public:
		...
		MapOfJSValues& GetValues()
		{
			return fValues;
		}

		VectorOfVString& GetPropsChrono()
		{
			return fPropsChrono;
		}
		...
		void SetContextRef(JS4D::ContextRef inContextRef)
		{
			fContextRef = inContextRef;
		}

	protected:
		VectorOfVString fPropsChrono;
		MapOfJSValues fValues;
		JS4D::ContextRef fContextRef;

};


class ENTITY_API VJSDynamicObj : public XBOX::VJSClass<VJSDynamicObj, DynamicObj>
{
	public:
		typedef VJSClass<VJSDynamicObj, DynamicObj>	inherited;

		static	void			Initialize( const XBOX::VJSParms_initialize& inParms, DynamicObj* obj);
		static	void			Finalize( const XBOX::VJSParms_finalize& inParms, DynamicObj* obj);
		static	void			GetProperty( XBOX::VJSParms_getProperty& ioParms, DynamicObj* obj);
		static	bool			SetProperty( VJSParms_setProperty& ioParms, DynamicObj* obj);
		static	void			GetPropertyNames( XBOX::VJSParms_getPropertyNames& ioParms, DynamicObj* obj);
		static	void			GetDefinition( ClassDefinition& outDefinition);

		//static void _addClass(XBOX::VJSParms_callStaticFunction& ioParms, DynamicObj* obj); 

};

const long max_char_ascii_buffer = 128;

class AsciiBuffer
{
public:

	AsciiBuffer(const VString& from, bool toUpperCase = false, bool trimSpaces = false);
...
protected:
	char fData[max_char_ascii_buffer + 1];
	sLONG fLength;
...
class ENTITY_API VJSAsciiStr : public XBOX::VJSClass<VJSAsciiStr, AsciiBuffer>
{
public:
	typedef VJSClass<VJSAsciiStr, AsciiBuffer>	inherited;

	static	void			Initialize(const XBOX::VJSParms_initialize& inParms, AsciiBuffer* obj);
	static	void			Finalize(const XBOX::VJSParms_finalize& inParms, AsciiBuffer* obj);
	static	void			GetDefinition(ClassDefinition& outDefinition);

	//static void _addClass(XBOX::VJSParms_callStaticFunction& ioParms, DynamicObj* obj); 
	static void _toString(XBOX::VJSParms_callStaticFunction& ioParms, AsciiBuffer* obj);
...
class ENTITY_API VJSDynObj : public XBOX::VJSClass<VJSDynObj, DynObj>
{
	public:
		typedef VJSClass<VJSDynObj, DynObj>	inherited;

		static	void			Initialize( const XBOX::VJSParms_initialize& inParms, DynObj* obj);
		static	void			Finalize( const XBOX::VJSParms_finalize& inParms, DynObj* obj);
		static	void			GetProperty( XBOX::VJSParms_getProperty& ioParms, DynObj* obj);
		static	bool			SetProperty( VJSParms_setProperty& ioParms, DynObj* obj);
		static	void			GetPropertyNames( XBOX::VJSParms_getPropertyNames& ioParms, DynObj* obj);
		static	void			GetDefinition( ClassDefinition& outDefinition);
