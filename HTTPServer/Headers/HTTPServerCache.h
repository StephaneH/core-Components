...
public:
	...
	bool					GetIsStaticURL() const { return fIsStaticUrl; }
	void					SetIsStaticURL (bool inStaticURL) { fIsStaticUrl = inStaticURL; }

	bool					IsCompressed() const { return fCompressionMode != COMPRESSION_NONE; }
	...
	uLONG					GetNbLoads() const { return fNbLoads; }
	void					IncrementLoad() { ++fNbLoads; }

	XBOX::VSize				GetSize() const { return fCachedContent.GetDataSize(); }
...
private:
	...
	XBOX::VMemoryBuffer<>	fCachedContent;		//	Data of the cached file
...
public:
	...
	bool					IsFileInCache(const XBOX::VString& inURL, const XBOX::VString& inHostUUIDString);
	bool					AddFileInCache(const XBOX::VString& inURL, const XBOX::VString& inHostUUIDString, const XBOX::VFilePath& inFilePath);
	...
	XBOX::VError			AddResource (const XBOX::VString& inPattern, VHTTPResource *inResource);
	XBOX::VError			RemoveResource (const XBOX::VString& inPattern);
