...
public:
	...
	void								LoadFromBag (const XBOX::VValueBag& inValueBag, const XBOX::VFilePath& inProjectFolderPath);
...
{
public:
										VHTTPServerProjectSettings (const XBOX::VValueBag *inBag, const XBOX::VString& inProjectFolderPath);
	...
	const XBOX::VFilePath&				GetProjectFolderPath() const { return fProjectFolderPath; }
	void								SetProjectFolderPath (const XBOX::VFilePath& inValue) { fProjectFolderPath.FromFilePath (inValue); }

	bool								GetUseWALibVirtualFolder() const { return fUseWALibVirtualFolder; }
	void								SetUseWALibVirtualFolder (bool inValue) { fUseWALibVirtualFolder = inValue; }
...
protected:
	...
	/* Default Project Folder */
	XBOX::VFilePath						fProjectFolderPath;

	/* Automatically add waLib VirtualFolder */
	bool								fUseWALibVirtualFolder;
