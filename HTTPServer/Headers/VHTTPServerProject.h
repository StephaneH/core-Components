...
typedef std::vector<XBOX::VRefPtr<VVirtualHost> >												VectorOfVirtualHost;
typedef std::map<XBOX::VRefPtr<XBOX::VRegexMatcher>, XBOX::VRefPtr<IWebSocketHandler> >			VWebSocketHandlerMap;

	
class VHTTPServerProject: public XBOX::VObject, public IHTTPServerProject
{
public:
											VHTTPServerProject (VHTTPServer *inServer, XBOX::VFileSystemNamespace *inFileSystemNameSpace);
	...
	virtual XBOX::VError					AddWebSocketHandler (IWebSocketHandler *inWebSocketHandler);
	virtual XBOX::VError					RemoveWebSocketHandler (IWebSocketHandler *inWebSocketHandler);
	virtual IWebSocketHandler				*RetainMatchingWebSocketHandler (const XBOX::VString &inResourceName);
...
private:
	...
	VectorOfVirtualHost						fVirtualHosts;
	...
	XBOX::VCriticalSection					fWebSocketHandlersMutex;
	VWebSocketHandlerMap					fWebSocketHandlers;
