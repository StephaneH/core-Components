...
#ifndef WITH_CSRF_EXCEPTION_FOR_FILE_SCHEME
	#define WITH_CSRF_EXCEPTION_FOR_FILE_SCHEME		1
#endif
...
public:
	...
	virtual void							AnswerIt() = 0;
	virtual bool							Answered() const = 0;
};
...
public:
	...
	*/
	...
	virtual bool							IsFileInCache(const XBOX::VString& inURL, const XBOX::VString& inHostUUIDString) = 0;
	virtual bool							AddFileInCache(const XBOX::VString& inURL, const XBOX::VString& inHostUUIDString, const XBOX::VFilePath& inFilePath) = 0;
};
...
public:
	...
	virtual const XBOX::VString&			GetUUIDString() const = 0;
};
...
public:
	...
	/*
	 *	Get/Set Num of Request in HTTP Log buffer between flushes (default default value 10)
	 *	VHTTPServer::SetMaxRequestInLogBuffer(1) // allow Server to flush log at each request
	 */
	virtual sLONG							GetMaxRequestInLogBuffer() const = 0;
	virtual void							SetMaxRequestInLogBuffer(sLONG inValue) = 0;
};
