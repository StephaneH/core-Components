...
#define CHTTP_SERVER_USE_OLD_CLIENT_WS				0
#define CHTTP_SERVER_USE_NEW_WEB_SOCKET_CODE		1
...
#if CHTTP_SERVER_USE_NEW_WEB_SOCKET_CODE == 1
...
public:
	...
	virtual	XBOX::VError		ConnectToServer (const XBOX::VURL &inUrl, bool isBlocking = true) = 0;
...
// Needed by VHTTPWebsocketServerHandler
