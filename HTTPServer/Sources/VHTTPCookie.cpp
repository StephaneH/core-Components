...
// 		return true;
// 
// 	return (fName.EqualToString (inCookie.fName) && fValue.EqualToString (inCookie.fValue));
// }
// 
// 
...
// 			HTTPProtocol::MakeRFC822GMTDateString (curTime, timeString);
...
// 
// 		if ((pos = HTTPServerTools::FindASCIICString (string, "secure")) == 1)
// 		{
// 			SetSecure (true);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "httpOnly")) == 1)
// 		{
// 			SetHttpOnly (true);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "version")) == 1)
// 		{
// 			SetVersion (1);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "max-age")) == 1)
// 		{
// 			HTTPServerTools::ExtractFieldNameValue (string, nameString, valueString);
// 			fMaxAge = valueString.GetLong();
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "expires")) == 1)
// 		{
// 			XBOX::VTime curTime;
...
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "path")) == 1)
// 		{
// 			HTTPServerTools::ExtractFieldNameValue (string, nameString, fPath);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "domain")) == 1)
// 		{
// 			HTTPServerTools::ExtractFieldNameValue (string, nameString, fDomain);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "comment")) == 1)
// 		{
// 			HTTPServerTools::ExtractFieldNameValue (string, nameString, fComment);
// 		}
// 		else if ((pos = HTTPServerTools::FindASCIICString (string, "=")))
// 		{
// 			HTTPServerTools::ExtractFieldNameValue (string, fName, fValue);
// 		}
// 	}
// }
