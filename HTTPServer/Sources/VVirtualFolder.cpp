...
VVirtualFolder::VVirtualFolder (const XBOX::VString& inLocationPath, const XBOX::VString& inIndexFileName, const XBOX::VString& inName, const XBOX::VString& inProjectPattern, bool createIndexIfNotExist)
