...
#define ACTIVATE_NEXT_JS_AST_WALKER 0
...
#define ACTIVATE_OUTLINE_ICONS_DISPLAYING 0

#define ACTIVATE_SYMBOL_TABLE_LIVE_REQUEST 0

#define ACTIVATE_CORE_AUTOCOMPLETE_DOC_PARSING 1
#define ACTIVATE_CLIENT_SIDE_AUTOCOMPLETE_DOC_PARSING 1
#define ACTIVATE_SERVER_SIDE_AUTOCOMPLETE_DOC_PARSING 1
#define ACTIVATE_SERVER_MODULES_AUTOCOMPLETE_DOC_PARSING 0
#define ACTIVATE_SERVER_SIDE_KLUDGE_PARSING 1

#define ACTIVATE_CORE_SYMBOLS_GENERATION 0
...
enum
{
	/*	0	*/eSymbolDefinitionVisibilityPrivate=0,
	/*	1	*/eSymbolDefinitionVisibilityPublic
};
typedef sLONG ESymbolDefinitionVisibility;
...
enum
{
	/*	0	*/	eSymbolScopeStatusUpToDate = 0,
	/*	1	*/	eSymbolScopeStatusNew,
	/*	2	*/	eSymbolScopeStatusModified,
	/*	3	*/	eSymbolScopeStatusDeletable
};
typedef sLONG ESymbolScopeStatus;

enum
{
	/*	0	*/	eSymbolDefinitionKindKeyword=0,
	/*	1	*/	eSymbolDefinitionKindFunctionDeclaration,
	/*	2	*/	eSymbolDefinitionKindFunctionExpression,
	/*	3	*/	eSymbolDefinitionKindCatch,
	/*	4	*/	eSymbolDefinitionKindWith,
	/*	5	*/	eSymbolDefinitionKindUndefined,
	/*	6	*/	eSymbolDefinitionKindObject,
	/*	7	*/	eSymbolDefinitionKindProperty
};
typedef sLONG ESymbolDefinitionKind;

enum
{
	/*	0	*/	eSymbolDefinitionTypeNull,
	/*	1	*/	eSymbolDefinitionTypeBoolean,
	/*	2	*/	eSymbolDefinitionTypeNumber,
	/*	3	*/	eSymbolDefinitionTypeUndefined,
	/*	4	*/	eSymbolDefinitionTypeString,
	/*	5	*/	eSymbolDefinitionTypeArray,
	/*	6	*/	eSymbolDefinitionTypeRegExp,
	/*	7	*/	eSymbolDefinitionTypeFunction,
	/*	8	*/	eSymbolDefinitionTypeObject,
	/*	9	*/	eSymbolDefinitionTypeDate,
	/*	10	*/	eSymbolDefinitionTypeError,
	/*	11	*/	eSymbolDefinitionTypeEvalError,
	/*	12	*/	eSymbolDefinitionTypeRangeError,
	/*	13	*/	eSymbolDefinitionTypeReferenceError,
	/*	14	*/	eSymbolDefinitionTypeSyntaxError,
	/*	15	*/	eSymbolDefinitionTypeTypeError,
	/*	16	*/	eSymbolDefinitionTypeURIError,
	/*	17	*/	eSymbolDefinitionTypeKeywordBreak,
	/*	18	*/	eSymbolDefinitionTypeKeywordCase,
	/*	19	*/	eSymbolDefinitionTypeKeywordCatch,
	/*	20	*/	eSymbolDefinitionTypeKeywordContinue,
	/*	21	*/	eSymbolDefinitionTypeKeywordDebugger,
	/*	22	*/	eSymbolDefinitionTypeKeywordDefault,
	/*	23	*/	eSymbolDefinitionTypeKeywordDelete,
	/*	24	*/	eSymbolDefinitionTypeKeywordDo,
	/*	25	*/	eSymbolDefinitionTypeKeywordElse,
	/*	26	*/	eSymbolDefinitionTypeKeywordFinally,
	/*	27	*/	eSymbolDefinitionTypeKeywordFor,
	/*	28	*/	eSymbolDefinitionTypeKeywordFunction,
	/*	29	*/	eSymbolDefinitionTypeKeywordIf,
	/*	30	*/	eSymbolDefinitionTypeKeywordIn,
	/*	31	*/	eSymbolDefinitionTypeKeywordInstanceof,
	/*	32	*/	eSymbolDefinitionTypeKeywordTypeof,
	/*	33	*/	eSymbolDefinitionTypeKeywordNew,
	/*	34	*/	eSymbolDefinitionTypeKeywordVar,
	/*	35	*/	eSymbolDefinitionTypeKeywordReturn,
	/*	36	*/	eSymbolDefinitionTypeKeywordVoid,
	/*	37	*/	eSymbolDefinitionTypeKeywordSwitch,
	/*	38	*/	eSymbolDefinitionTypeKeywordWhile,
	/*	39	*/	eSymbolDefinitionTypeKeywordThis,
	/*	40	*/	eSymbolDefinitionTypeKeywordWith,
	/*	41	*/	eSymbolDefinitionTypeKeywordThrow,
	/*	42	*/	eSymbolDefinitionTypeKeywordTry,
	/*	43	*/	eSymbolDefinitionTypeKeywordClass,
	/*	44	*/	eSymbolDefinitionTypeKeywordConst,
	/*	45	*/	eSymbolDefinitionTypeKeywordEnum,
	/*	46	*/	eSymbolDefinitionTypeKeywordExport,
	/*	47	*/	eSymbolDefinitionTypeKeywordExtends,
	/*	48	*/	eSymbolDefinitionTypeKeywordImport,
	/*	49	*/	eSymbolDefinitionTypeKeywordSuper,
	/*	50	*/	eSymbolDefinitionTypeKeywordNull,
	/*	51	*/	eSymbolDefinitionTypeKeywordTrue,
	/*	52	*/	eSymbolDefinitionTypeKeywordFalse

};
typedef sLONG ESymbolDefinitionType;
...
public:
	 ...
	 *	SCOPE MANAGEMENT
	 */
	virtual bool GetGlobalScope(const XBOX::VString& inScopeName, const ESymbolScopeType& inScopeType, const ESymbolFileExecContext& inExecutionContext, sLONG& outScopeId) const = 0;
	virtual void SetGlobalScope(const XBOX::VString& inScopeName, const ESymbolScopeType& inScopeType, const ESymbolFileExecContext& inExecutionContext, sLONG& outScopeId) = 0;

	virtual bool GetScope(const XBOX::VString& inScopeName, const ESymbolScopeType& inScopeType, const sLONG& inParentScopeId, const sLONG& inSourceId, const ESymbolFileExecContext& inExecutionContext, sLONG& outScopeId) const = 0;
	virtual void GetScope(const sLONG& inSourceId, const ESymbolFileExecContext& inExecutionContext, const sLONG& inLineNumber, const sLONG& inOffsetValue, sLONG& outScopeId) const = 0;
	
	virtual void SetScope(const XBOX::VString& inScopeName, const ESymbolScopeType& inScopeType, const sLONG& inParentScopeId, const sLONG& inSourceId, const ESymbolFileExecContext& inExecutionContext, const sLONG& inFromLine, const sLONG& inFromOffset, const sLONG& inToLine, const sLONG& inToOffset, sLONG& outScopeId) = 0;
	
	virtual void PrepareScopeUpdates(const sLONG& inSourceId, const ESymbolFileExecContext& inExecutionContext) = 0;
	virtual void FinalizeScopeUpdates(const sLONG& inSourceId, const ESymbolFileExecContext& inExecutionContext) = 0;
	...
	virtual void SetScopeStatus(const sLONG& inScopeId, const ESymbolScopeStatus& inScopeStatus) = 0;
	virtual void SetScopeBondaries(const sLONG& inScopeId, const sLONG& inFromLine, const sLONG& inFromOffset, const sLONG& inToLine, const sLONG& inToOffset) = 0;
	
	/*
	 *	SYMBOL'S NAME MANAGEMENT
	 */
	virtual bool GetName(const XBOX::VString& inSymbolName, const sLONG& inScopeId, const ESymbolFileExecContext& inExecutionContext, sLONG& outSymbolNameId) const = 0;
	...
	virtual void SetName(const XBOX::VString& inSymbolName, const sLONG& inScopeId, const ESymbolFileExecContext& inExecutionContext, sLONG& outSymbolNameId) = 0;
	
	/*
	 *	SYMBOL'S DEFINITION MANAGEMENT
	 */
	virtual bool GetDefinitions(const sLONG& inScopeId, const ESymbolFileExecContext& inExecutionContext, std::vector<sLONG>& outIds) const = 0;
	virtual bool GetDefinition(const sLONG& inScopeId, const sLONG& inNameId, const ESymbolFileExecContext& inExecutionContext, sLONG& outId) const = 0;
	virtual bool GetDefinitionKind(const sLONG& inDefinitionId, ESymbolDefinitionKind& outKind) const = 0;
	virtual bool GetDefinitionType(const sLONG& inDefinitionId, ESymbolDefinitionType& outType) const = 0;
	virtual bool GetDefinitionName(const sLONG& inDefinitionId, XBOX::VString& outName) const = 0;
	virtual bool GetDefinitionInstanceFlag(const sLONG& inDefinitionId, bool& outFlag) const = 0;
	virtual bool GetDefinitionLocalVariableFlag(const sLONG& inDefinitionId, bool& outFlag) const = 0;
	
	virtual void SetDefinition(const sLONG& inScopeId, const sLONG& inNameId, const ESymbolFileExecContext& inExecutionContext, const ESymbolDefinitionKind& inKind, const ESymbolDefinitionType& inType, const ESymbolDefinitionVisibility& inVisibility, const bool& inConstructorFlag, const bool& inInstanceFlag, const bool& inLocalVariableFlag) = 0;
	
	/*
	 *	SYMBOL'S SUGGESTION MANAGEMENT
	 */
	virtual void GetConstructorNames(const ESymbolFileExecContext& inExecutionContext, std::vector<XBOX::VString>& outNames) const = 0;
	virtual void GetConstructorNames(const ESymbolFileExecContext& inExecutionContext, const XBOX::VString& inStartWith, std::vector<XBOX::VString>& outNames) const = 0;
	
	virtual void GetIdentifierNames(const ESymbolFileExecContext& inExecutionContext, const sLONG& inFromScopeId, std::vector<XBOX::VString>& outNames) const = 0;
	virtual void GetIdentifierNames(const ESymbolFileExecContext& inExecutionContext, const sLONG& inFromScopeId, const XBOX::VString& inStartWith, std::vector<XBOX::VString>& outNames) const = 0;
	virtual void GetIdentifierNames(const sLONG& inDefinitionId, std::vector<XBOX::VString>& outNames) const = 0;
#endif
