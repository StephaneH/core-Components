...
public:
	 ...
	 */
	virtual bool GetReference(const sLONG& inFromScopeId, const sLONG& inToScopeId, ISymbolUpdateParameters* inUpdateParameters, sLONG& outReferenceId) const = 0;
	virtual bool GetReferenceFromScopeId(const sLONG& inFromScopeId, sLONG& outToScopeId) const = 0;
	
	virtual void SetReference(const sLONG& inFromScopeId, const sLONG& inToScopeId, const sLONG& inSourceId) = 0;
