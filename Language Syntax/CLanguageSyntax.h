...
public:
	...
	virtual void SetSymbolsEditionState(const Symbols::IFile* inFile, bool inEditionState) = 0;
	virtual void GetSymbolIds(const Symbols::IFile* inFile, bool inEditionState, std::vector<sLONG>& outIds) = 0;
