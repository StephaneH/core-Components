...
public:
	...
	virtual std::vector< Symbols::ISymbol * > GetSymbolsByName( const XBOX::VString &inName ) = 0;
	virtual std::vector< Symbols::ISymbol * > GetSymbolsByName( Symbols::ISymbol *inOwner, const XBOX::VString &inName, Symbols::IFile *inOwnerFile = NULL ) = 0;
	virtual std::vector< Symbols::ISymbol * > GetClassSymbols( Symbols::ISymbol *inOwner, const XBOX::VString &inName, Symbols::IFile *inOwnerFile = NULL ) = 0;
	...
	virtual std::vector< Symbols::ISymbol * > GetNamedSubSymbols( Symbols::ISymbol *inOwner, Symbols::IFile *inOwnerFile = NULL, SortingOptions inOptions = kDefault ) = 0;
	//virtual std::vector< Symbols::IFile * > GetFilesByPath( const XBOX::VFilePath &inPath ) = 0;
	virtual std::vector< Symbols::IFile * > GetFilesByPathAndBaseFolder( const XBOX::VFilePath &inPath, const ESymbolFileBaseFolder inBaseFolder) = 0;
	virtual std::vector< Symbols::IFile * > GetFilesByName( const XBOX::VString &inName ) = 0;
	...
	virtual std::vector< Symbols::ISymbol * > GetLikeNamedSubSymbols( Symbols::ISymbol *inOwner, const XBOX::VString &inLikeName, const bool inFullyLoad = false) = 0;
