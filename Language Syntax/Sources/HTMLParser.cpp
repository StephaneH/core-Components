...
#if _DEBUG
void HTMLParser::Test()
{
	class Tester : public HTMLParser::ICallback {
	...
	TokenList tokens;
	parser->Parse( CVSTR( "This is &amp; a bunch of plain text <!-- and a single comment --> followed by <a href = \"test.html\">a link</a> and <br /> self-closing tags" ), NULL, &state, &test );
