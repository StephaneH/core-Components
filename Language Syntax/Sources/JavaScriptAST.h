...
namespace JavaScriptAST {
	...
	public:
		...
		virtual ESymbolDeclarationType GetSymbolDeclarationType() const = 0;
		...
		virtual bool GetBondaries(sLONG& outFromLine, sLONG& outFromOffset, sLONG& outToLine, sLONG& outToOffset) const { return false; }
	...
	public:
		...
		virtual ESymbolDeclarationType GetSymbolDeclarationType() const;
	...
	public:
		...
		void SetInstanceFlag(const bool& inValue);
	...
	public:
		...
		virtual ISymbolDeclaration* Clone() const;
		virtual void ToString(XBOX::VString& inDump) const;
		virtual bool GetBondaries(sLONG& outFromLine, sLONG& outFromOffset, sLONG& outToLine, sLONG& outToOffset) const;
		
		void AddObjectFieldDeclaration(ISymbolDeclaration* inDeclaration);
		void SetBoundaries(const sLONG& inFromLine, const sLONG& inFromOffset, const sLONG& inToLine, const sLONG& inToOffset);
	...
	public:
		...
		ISymbolDeclaration* GetLhs() const;
	...
	{
	public:
		SymbolScopeDeclaration(SymbolScopeDeclaration* inParent, const XBOX::VString& inName, const ESymbolScopeType& inType, const sLONG& inFromLine, const sLONG& inFromOffset, const sLONG& inToLine, const sLONG& inToOffset, const bool& inConstructorFlag);
		...
		static bool Compare(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		
		/*
		 * SCOPE PRINT
		 */
		static void Print(SymbolScopeDeclaration* inScope, const XBOX::VString& inTabSpace);
	...
	private:
		 ...
		 */
		static bool _CompareName(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareType(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareDeclarations(const std::vector<ISymbolDeclaration*>& inFrom, const std::vector<ISymbolDeclaration*> inTo);
		static bool _ComparePropertyDeclarations(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareAssignmentDeclarations(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareVariableDeclarations(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareFunctionDeclarations(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		static bool _CompareChildren(const SymbolScopeDeclaration* inFromScope, const SymbolScopeDeclaration* inToScope);
		
		/*
		 * DECLARATIONS PRINT
		 */
		static void _PrintScope(const XBOX::VString&, SymbolScopeDeclaration*);
	...
	class Visitor {
	public:
		static Visitor* GetDeclarationParser( ISymbolTable* inSymTable, Symbols::IFile* inOwningFile, JavaScriptParserDelegate* inDelegate = NULL, SymbolScopeDeclaration* inDeclarationScopes = NULL);
