...
private:
	bool AdvanceOneToken( int &outToken, TokenList *outTokens, bool inIgnoreNewLines );
	int SkipSemiColons();
...
public:
	...
	virtual int GetNextTokenForParser() { return GetNextTokenForParser( true ); }
	virtual int GetNextTokenForParser( bool inIgnoreNewLines );
