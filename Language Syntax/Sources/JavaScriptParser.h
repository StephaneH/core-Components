...
private:
	...
	void _SuggestIdentifiers(const XBOX::VString& inStartsWith, const bool& inProcessDotExpression);
	...
	bool _GetHtmlFileIdFromJsScriptFile(Symbols::IFile* inFile, sLONG& outFileId) const;
