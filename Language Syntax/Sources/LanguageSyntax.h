...
public:
	...
	static void _GetCSSCompletions( XBOX::VJSParms_callStaticFunction &ioParams, void * );
	static void _GetASTComputationResults( XBOX::VJSParms_callStaticFunction &ioParams, void * );
};
