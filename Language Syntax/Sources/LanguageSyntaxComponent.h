...
public:
	...
	virtual void UseNextGen( bool inUseNextGen );
...
private:
	...
	DisplayDocumentationSignal fDisplayDocumentationSignal;

public:
	virtual DisplayDocumentationSignal& GetDisplayDocumentationSignal() { return fDisplayDocumentationSignal; };
};
