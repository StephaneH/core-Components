...
private:
	...
	ParserReturnValue ParseTable( class SuggestionList &outSuggestions, class ILexerToken * &outToken, VString *outTableName = NULL );
	...
	ParserReturnValue ParseTableRefTerminal( class SuggestionList &outSuggestions, class ILexerToken* &outToken );
	ParserReturnValue ParseTableRef( class SuggestionList &outSuggestions, class ILexerToken * &outToken );
