...
public:
	...
	virtual void DebugDump() const
	{
		VString msg("[SymbolTable] File Dump ");
		msg.AppendString("Id(");				msg.AppendLong(GetID());				msg.AppendString(") ");
		msg.AppendString("File(");				msg.AppendString(GetPath());			msg.AppendString(") ");
		msg.AppendString("BaseFolder(");		msg.AppendLong(GetBaseFolder());		msg.AppendString(") ");
		msg.AppendString("ExecutionContext(");	msg.AppendLong(GetExecutionContext());	msg.AppendString(") ");
		msg.AppendString("\n");
		DebugMsg(msg);
	}
#endif
