...
public:
    ...
    XBOX::VError ValidateBasicAuthentication(const XBOX::VString& inName, const XBOX::VString& inPassword, bool inHashedPassword, bool* outAuthOk, CUAGSession* &outUAGSession, XBOX::VJSGlobalContext* inContext, XBOX::VJSONObject* requestInfo);
