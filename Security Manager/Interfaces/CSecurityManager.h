...
public:
    ...
    virtual XBOX::VError ValidateKerberosAuthentication(const XBOX::VString& inAuthData, bool* outAuthOk, XBOX::VString* outAuthData, CUAGSession* &outUAGSession, XBOX::VJSONObject* requestInfo)=0;
