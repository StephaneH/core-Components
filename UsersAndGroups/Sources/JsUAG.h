...
public:
	...
	static void _forceExpire(XBOX::VJSParms_callStaticFunction& ioParms, CUAGSession* inSession); //  forceExpire()

	static void _getID( XBOX::VJSParms_getProperty& ioParms, CUAGSession* inSession); // ID : string
	static void _getUser( XBOX::VJSParms_getProperty& ioParms, CUAGSession* inSession); // user
	static void _getLifeTime( XBOX::VJSParms_getProperty& ioParms, CUAGSession* inSession); // lifeTime : long
	static void _getExpiration( XBOX::VJSParms_getProperty& ioParms, CUAGSession* inSession); // expiration : date
