...
class UAGDirectory : public VComponentImp<CUAGDirectory>
{
	public:
		...
		bool TakenByListener(const VString& inUserName, const VString& inPassword, VError& err, UAGSession* &session, VJSContext* inJSContext, bool passIsKey, VJSONObject* requestInfo);
		virtual CUAGSession* OpenSession(const VString& inUserName, const VString& inPassword, VError* outErr = nil, VJSContext* inJSContext = nil, bool passIsKey = false, VJSONObject* requestInfo = nil);
		virtual CUAGSession* OpenSession(const VString& inUserAtRealm, VError* outErr = nil, VJSContext* inJSContext = nil, VJSONObject* requestInfo = nil);
		virtual CUAGSession* OpenSession(CUAGUser* inUser, VError* outErr = nil, VJSContext* inJSContext = nil, VJSONObject* requestInfo = nil);
		virtual CUAGSession* OpenSession(VJSObject* inSessionObj, VError* outErr = nil, VJSContext* inJSContext = nil, VJSONObject* requestInfo = nil);
		virtual CUAGSession* MakeDefaultSession(bool RealSession, VError* outErr = nil, VJSContext* inJSContext = nil,bool fromLogout = false, VJSONObject* requestInfo = nil);
		...
		virtual CUAGThreadPrivilege* NewThreadPrivilege();
	...
	protected:
		...
		UAGSession* BuildSession(VJSObject resultObj, VJSContext* inJSContext, VJSONObject* requestInfo);
		...
		VCriticalSection fSessionMutex;
		UAGSession* fDefaultSession;
