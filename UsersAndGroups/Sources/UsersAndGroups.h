...
#include "JavaScript/Sources/VJSClass.h"
...
class CUAGDirectory : public XBOX::CComponent
{
	public:
		...
		virtual CUAGSession* OpenSession(const XBOX::VString& inUserName, const XBOX::VString& inPassword, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, bool passIsKey = false, XBOX::VJSONObject* requestInfo = nil) = 0;
		virtual CUAGSession* OpenSession(const XBOX::VString& inUserAtRealm, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, XBOX::VJSONObject* requestInfo = nil) = 0;
		virtual CUAGSession* OpenSession(CUAGUser* inUser, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, XBOX::VJSONObject* requestInfo = nil) = 0;
		virtual CUAGSession* OpenSession(XBOX::VJSObject* inSessionObj, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, XBOX::VJSONObject* requestInfo = nil) = 0;
		virtual CUAGSession* MakeDefaultSession(bool RealSession, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, bool fromLogout = false, XBOX::VJSONObject* requestInfo = nil) = 0;
		

		virtual	XBOX::VJSObject	CreateJSDirectoryObject( const XBOX::VJSContext& inContext) = 0;
		virtual CUAGUser* RetainParamUser(XBOX::VJSParms_callStaticFunction& ioParms, sLONG paramNum) = 0;
		virtual CUAGGroup* RetainParamGroup(XBOX::VJSParms_callStaticFunction& ioParms, sLONG paramNum) = 0;
		...
		virtual CUAGThreadPrivilege* NewThreadPrivilege() = 0;
...
class ISessionCleaner : public XBOX::IRefCountable
{
	public:
...
class CUAGThreadPrivilege : public XBOX::CComponent
{
public:
	enum { Component_Type = 'ugtp' };
...
class CUAGSession : public XBOX::CComponent
{
	public:
		...
		virtual bool BelongsTo(const XBOX::VUUID& inGroupID, CUAGThreadPrivilege* inThreadPrivileges, bool checkNoAdmin = true) = 0;

		virtual bool BelongsTo(CUAGGroup* inGroup, CUAGThreadPrivilege* inThreadPrivileges, bool checkNoAdmin = true) = 0;
		...
		virtual sLONG PromoteIntoGroup(CUAGGroup* inGroup, CUAGThreadPrivilege* inThreadPrivileges) = 0; // returns a promotion token or 0 if not promotion was necessary

		virtual void UnPromoteFromToken(sLONG promotionToken, CUAGThreadPrivilege* inThreadPrivileges) = 0;
		...
		virtual void forceExpire() = 0;

		virtual bool IsEmpty() const = 0;

		virtual void SetLifeTime( sLONG inLifeTime) = 0;

		virtual void GetExpiration(XBOX::VTime& outExpiration) const = 0;

		virtual sLONG GetLifeTime() const = 0;
		...
		virtual XBOX::IRefCountable* GetExtraData(void* selector) = 0;
		virtual void SetExtraData(void* selector, XBOX::IRefCountable* data) = 0;
		virtual void RemoveExtraData(void* selector) = 0;
		virtual void ClearAllExtraData() = 0;
		virtual void LockExtraData() = 0;
		virtual void UnLockExtraData() = 0;

		virtual XBOX::VJSONObject* RetainRequestInfo() = 0;

		virtual void AddSessionCleaner(void* selector, ISessionCleaner* cleaner) = 0;
		virtual void RemoveSessionCleaner(void* selector) = 0;
		virtual ISessionCleaner* RetainSessionCleaner(void* selector) = 0;

		virtual bool NeedsCookie() const = 0;
