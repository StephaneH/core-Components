...
class CUAGDirectory : public XBOX::CComponent
{
	public:
		...
		virtual CUAGSession* OpenSession(const XBOX::VString& inUserName, const XBOX::VString& inPassword, XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, bool passIsKey = false) = 0;
