...
class CUAGDirectory : public XBOX::CComponent
{
	public:
		...
		virtual CUAGSession* MakeDefaultSession(XBOX::VError* outErr = nil, XBOX::VJSContext* inJSContext = nil, bool fromLogout = false, XBOX::VJSONObject* requestInfo = nil) = 0;
